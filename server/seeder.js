...
const seedUsers = async () => {
  try {
    ...
    const dummyUsers = [
      ...
      {
        name: "Usman Tariq (D.Pharm)",
        email: "usman.pharmacy@campusconnect.com",
        registeration_number: "2024F-muldpharm-171",
        password: hashedPassword,
        role: "student",
        department: "Doctor of Pharmacy",
        semester: 4,
      ...
      // --- ALL DEPARTMENTS MALE & FEMALE STUDENTS ---
      {
        name: "Hamza Siddiqui (BBA)",
        email: "hamza.bba@campusconnect.com",
        registeration_number: "2023F-mulbba-201",
        password: hashedPassword,
        role: "student",
      ...
      {
        name: "Mahnoor Khan (BBA)",
        email: "mahnoor.bba@campusconnect.com",
        registeration_number: "2023F-mulbba-202",
        password: hashedPassword,
        role: "student",
        department: "Business Administration",
        semester: 5,
      ...
      {
        name: "Shahzaib Ali (EE)",
        email: "shahzaib.ee@campusconnect.com",
        registeration_number: "2022F-mulee-301",
        password: hashedPassword,
        role: "student",
      ...
      {
        name: "Laiba Noor (EE)",
        email: "laiba.ee@campusconnect.com",
        registeration_number: "2022F-mulee-302",
        password: hashedPassword,
        role: "student",
        department: "Electrical Engineering",
        semester: 7,
      ...
      {
        name: "Hassan Raza (ME)",
        email: "hassan.me@campusconnect.com",
        registeration_number: "2023S-mulme-401",
        password: hashedPassword,
        role: "student",
      ...
      {
        name: "Sana Zafar (ME)",
        email: "sana.me@campusconnect.com",
        registeration_number: "2023S-mulme-402",
        password: hashedPassword,
        role: "student",
        department: "Mechanical Engineering",
        semester: 6,
      ...
      {
        name: "Taimoor Baig (Maths)",
        email: "taimoor.math@campusconnect.com",
        registeration_number: "2024F-mulmath-501",
        password: hashedPassword,
        role: "student",
      ...
      {
        name: "Iqra Parvez (Maths)",
        email: "iqra.math@campusconnect.com",
        registeration_number: "2024F-mulmath-502",
        password: hashedPassword,
        role: "student",
        department: "Mathematics & Statistics",
        semester: 3,
      ...
      {
        name: "Zubair Ahmad (English)",
        email: "zubair.eng@campusconnect.com",
        registeration_number: "2023F-muleng-601",
        password: hashedPassword,
        role: "student",
      ...
      {
        name: "Maryam Bibi (English)",
        email: "maryam.eng@campusconnect.com",
        registeration_number: "2023F-muleng-602",
        password: hashedPassword,
        role: "student",
        department: "English & Humanities",
        semester: 5,
      ...
      {
        name: "Waqas Butt (Law)",
        email: "waqas.law@campusconnect.com",
        registeration_number: "2022F-mullaw-701",
        password: hashedPassword,
        role: "student",
      ...
      {
        name: "Khadija Rehman (Law)",
        email: "khadija.law@campusconnect.com",
        registeration_number: "2022F-mullaw-702",
        password: hashedPassword,
        role: "student",
        department: "Law & Political Science",
        semester: 7,
      ...
      {
        name: "Hafiz Saad (Islamic Studies)",
        email: "saad.islamic@campusconnect.com",
        registeration_number: "2024F-mulislamic-801",
        password: hashedPassword,
        role: "student",
      ...
      {
        name: "Sumaira Aslam (Islamic Studies)",
        email: "sumaira.islamic@campusconnect.com",
        registeration_number: "2024F-mulislamic-802",
        password: hashedPassword,
        role: "student",
        department: "Islamic Studies",
        semester: 2,
      ...
      {
        name: "Bilal Sheikh (Mass Comm)",
        email: "bilal.media@campusconnect.com",
        registeration_number: "2023F-mulmedia-901",
        password: hashedPassword,
        role: "student",
        department: "Mass Communication & Media",
        semester: 4,
        program: "BS Media Studies",
        section: "A",
      },
      {
        name: "Anum Shahzadi (Mass Comm)",
        email: "anum.media@campusconnect.com",
        registeration_number: "2023F-mulmedia-902",
        password: hashedPassword,
        role: "student",
        department: "Mass Communication & Media",
        semester: 4,
