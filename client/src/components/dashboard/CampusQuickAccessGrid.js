  ...
  const widgets = [
    {
      ...
      icon: <i className="fa-solid fa-utensils text-[#071A35] group-hover:text-[#00c2cb] transition-colors" />,
    ...
    },
    {
      ...
      icon: <i className="fa-solid fa-comments text-[#071A35] group-hover:text-[#00c2cb] transition-colors" />,
    ...
    },
    {
      ...
      icon: <i className="fa-solid fa-file-signature text-[#071A35] group-hover:text-[#00c2cb] transition-colors" />,
    ...
    },
    {
      ...
      icon: <i className="fa-solid fa-magnifying-glass text-[#071A35] group-hover:text-[#00c2cb] transition-colors" />,
      buttonText: "View Hub",
      path: "/lost-found",
    },
    {
      ...
      icon: <i className="fa-solid fa-bus text-[#071A35] group-hover:text-[#00c2cb] transition-colors" />,
    ...
    },
    {
      ...
      icon: <i className="fa-solid fa-briefcase text-[#071A35] group-hover:text-[#00c2cb] transition-colors" />,
